...
VALUES('test1', 1, 2000, 1, 1, 3.2, 'blah');

INSERT INTO `movies` (`title`,  `director_id`,  `copyright_year`, `genre_id`, `category_id`, `rating`, `notes`)
VALUES('test2', 2, 2000, 2, 2, 3.2, 'blah');

INSERT INTO `movies` (`title`,  `director_id`,  `copyright_year`, `genre_id`, `category_id`, `rating`, `notes`)
VALUES('test3', 3, 2000, 3, 3, 3.2, 'blah');

INSERT INTO `movies` (`title`,  `director_id`,  `copyright_year`, `genre_id`, `category_id`, `rating`, `notes`)
VALUES('test4', 4, 2000, 4, 4, 3.2, 'blah');

INSERT INTO `movies` (`title`,  `director_id`,  `copyright_year`, `genre_id`, `category_id`, `rating`, `notes`)
VALUES('test5', 5, 2000, 5, 5, 3.2, 'blah');